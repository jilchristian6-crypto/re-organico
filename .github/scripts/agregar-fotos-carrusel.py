...
insert = '''
                            <div class="hero-diapositiva" data-hero-diapositiva aria-hidden="true">
                                <img src="img/hero-carrusel/08-bolsas-compostables.webp" alt="Bolsas compostables Re Orgánico en uso" style="--posicion-foto: center 50%;" loading="lazy">
                            </div>
                            <div class="hero-diapositiva" data-hero-diapositiva aria-hidden="true">
                                <img src="img/hero-carrusel/09-contenedor-fruta.webp" alt="Contenedor compostable Re Orgánico con fruta" style="--posicion-foto: center 50%;" loading="lazy">
                            </div>'''
...
if '08-bolsas-compostables.webp' not in s:
